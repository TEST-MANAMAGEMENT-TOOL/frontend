...
export const BugImportModal: React.FC<BugImportModalProps> = ({
  isOpen,
  onClose,
  bugBashId,
  onImportComplete,
  ...
  // Step 3: Submit Excel + column mapping
  const handleImport = async () => {
    ...
    try {
      // Filter out empty mappings (columns that weren't mapped)
      ...
      const result = await bugBashFunctionalService.importBugs(bugBashId, file, filteredMapping);
